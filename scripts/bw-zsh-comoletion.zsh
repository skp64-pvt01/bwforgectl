  ...
  case $state in
    cmnds)
      commands=(
        ...
        "restore:Restores an object from the trash or archive."
        ...
        "archive:Archive an object from the vault."
...
function _bw_send {
  ...
  _arguments -C \
    ...
    '--emails[optional emails to access this Send. Can also be specified in JSON.]' \
